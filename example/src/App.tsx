        ...
        >
          ...
          <View style={styles.container}>
            ...
            <View style={styles.button_container}>
              <Button onPress={onPickImage} title="上传图片" color="#841584" />
              <View style={{ width: 10 }} />
              <Button onPress={pauseUpload} title="暂停上传" color="#841584" />
              <View style={{ width: 10 }} />
              <Button onPress={doUpload} title="继续上传" color="#841584" />
              <View style={{ width: 10 }} />
              <Button onPress={downloadImage} title="下载" color="#841584" />
            </View>
